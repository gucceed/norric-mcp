#!/usr/bin/env python3
"""Paced one-shot FI baseline into the Stockholm database.
...
from scripts._nordic_post_stockholm import FI, _safe_target, run  # noqa: E402,F401

CONFIRMATION = FI.confirmation
